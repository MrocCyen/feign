...
final class SynchronousMethodHandler implements MethodHandler {
	...
	private SynchronousMethodHandler(Target<?> target,
		...
		if (forceDecoding) {
			...
			this.decoder = null;
			this.asyncResponseHandler = new AsyncResponseHandler(logLevel, logger,
					decoder, errorDecoder, decode404, closeAfterDecode);
		}
	}
	...
	static class Factory {
		...
		public MethodHandler create(Target<?> target,
			...
			return new SynchronousMethodHandler(target, client, retryer, requestInterceptors, logger,
					...
					closeAfterDecode, propagationPolicy, forceDecoding);
		}
	}
}
